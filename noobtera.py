...
ADMINS = [708030615, 6063791789]  # 👮 दोनों Admin के User ID
USER_DATA_FILE = "user_data.json"
TERABOX_DOMAINS = ["terabox.com", "teraboxapp.com", "www.terabox.com", "dl.terabox.com"]
...
# ------------------ टेरेबॉक्स डाउनलोड (इंस्टेंट फिक्स्ड) ------------------
def download_terabox(url: str) -> str:
    try:
        ...
        # वीडियो URL निकालें (नया फिक्स्ड लॉजिक)
