...
async def handle_message(update: Update, context: CallbackContext):
    ...
    # Check if the message contains a valid Terabox link using regex
    terabox_pattern = re.compile(r'https?:\/\/(?:www\.)?([^\/]+)\.terabox\.(com|cc|net|co|org|in|us|biz|club|info|co\.uk|cn|asia|store|tv|fr|ru|de|it|eu|jp|kr|my|id|sg|hk|mex|com\.br|ar|co\.jp|co\.kr|co\.in|co\.id|us\.com|teraboxlink\.com)\/[a-zA-Z0-9\-_]+', re.IGNORECASE)
