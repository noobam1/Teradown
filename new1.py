...
async def handle_message(update: Update, context: CallbackContext):
    ...
    if terabox_pattern.match(user_message):
        ...
        try:
            ...
            # Extract the actual download URL from Terabox using RapidAPI
...
# Function to fetch the download link from Terabox using RapidAPI
...
def main():
    ...
    handlers = [
        ...
        CommandHandler("check_coins", check_coins),  # Added the check_coins handler
